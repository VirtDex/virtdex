...
This mechanism has been integrated into Bitcore-Node-VirtDex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/VirtDexpay/insight-api-VirtDex#web-socket-api](https://github.com/VirtDexpay/insight-api-VirtDex#web-socket-api)
* API: [https://github.com/VirtDexpay/insight-api-VirtDex#instantsend-transactions](https://github.com/VirtDexpay/insight-api-VirtDex#instantsend-transactions)
...
By default, the VirtDex Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the VirtDex Core daemon:
