...
VirtDex Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as VirtDex Core, where everyone uses
...
pay attention to for reviewers of VirtDex Core code.

General VirtDex Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: VirtDex Core uses tinyformat, which is type safe. Leave them out to avoid confusion
