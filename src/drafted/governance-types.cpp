...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VirtDexNetwork") type = VirtDexNetwork;
    if(strType == "VirtDexNetworkVariable") type = VirtDexNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VirtDexNetwork) s = "VirtDexNetwork";
    if(type == VirtDexNetworkVariable) s = "VirtDexNetworkVariable";
