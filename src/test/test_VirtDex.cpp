...
#define BOOST_TEST_MODULE VirtDex Test Suite

#include "test_VirtDex.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_VirtDex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
