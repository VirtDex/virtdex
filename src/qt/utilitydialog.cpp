    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("VirtDex Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About VirtDex Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  VirtDex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the VirtDex in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 VDX, 0.1 VDX, 1 VDX and 10 VDX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://VirtDexpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://VirtDexpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("VirtDex Core is shutting down...") + "<br /><br />" +
