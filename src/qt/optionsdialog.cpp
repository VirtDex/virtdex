    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("VDX-light"), QVariant("light"));
    ui->theme->addItem(QString("VDX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("VDX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("VDX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("VDX-traditional"), QVariant("trad"));
