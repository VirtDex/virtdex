    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("VirtDex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VirtDex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and VirtDex: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About VirtDex Core"), this);
    aboutAction->setStatusTip(tr("Show information about VirtDex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VirtDex Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VirtDex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VirtDex addresses"));
    ...
    openAction->setStatusTip(tr("Open a VirtDex: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VirtDex Core help message to get a list with possible VirtDex Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("VirtDex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VirtDex network", "", count));
    } else {
...
{
    QString strTitle = tr("VirtDex Core"); // default title
