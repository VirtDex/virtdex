...
2. run VirtDexd with -printalert or -sendalert like this:
   /path/to/VirtDexd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.VirtDex.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/VirtDex Core:0.12.0.58/"));
