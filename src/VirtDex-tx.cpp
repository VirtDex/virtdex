...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("VirtDex Core VirtDex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  VirtDex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded VirtDex transaction") + "\n" +
              "  VirtDex-tx [options] -create [commands]   " + _("Create hex-encoded VirtDex transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded VirtDex transaction
